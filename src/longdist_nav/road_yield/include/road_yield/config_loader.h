...
struct ManagerConfig
{
  ...
  double oncoming_confirm_time{0.0};
...
// Loads scalar behavior settings from YAML and the three independent CSVs:
// patrol route, avoidance points, and ordered left/right road boundaries.
