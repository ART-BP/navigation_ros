...
def parse_arguments():
    ...
    parser.add_argument("--start-x", type=finite_float, default=-3.93,
                        help="Start X in map coordinates (default: -3.93)")
    parser.add_argument("--start-y", type=finite_float, default=5.47,
                        help="Start Y in map coordinates (default: 5.47)")
    parser.add_argument("--end-x", type=finite_float, default=-4.06,
                        help="End X in map coordinates (default: -4.06)")
    parser.add_argument("--end-y", type=finite_float, default=-6.45,
