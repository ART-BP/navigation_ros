...
gnome-terminal --window -e 'bash -c "source ~/ros_navigation_ws/install/setup.bash;roslaunch omni_navigation real_navigation_C3.launch local_planner:=teb rviz:=true; exec bash"' \
