...
gnome-terminal --window -e 'bash -c "source ~/ros_navigation_ws/install/setup.bash;roslaunch omni_navigation real_navigation_Gdog_dengxin.launch local_planner:=teb dog_name:=small_dog rviz:=true; exec bash"' \
