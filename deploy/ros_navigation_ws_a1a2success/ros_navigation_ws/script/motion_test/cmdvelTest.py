...
def main():
    ...
    sequence = [
        ...
        (0.0,  0.0, 5.0, "Stop 5s"),
        # (0.8,  0.0, 5.0, "Forward 0.6 m/s 5s"),
        # # (0.0,  0.0, 5.0, "Stop 5s"),
        # # (0.7,  0.0, 5.0, "Forward 0.7 m/s 5s"),
        # # (0.0,  0.0, 5.0, "Stop 5s"),
        # # (0.6,  0.0, 5.0, "Forward 0.6 m/s 5s"),
        # # (1.0,  0.0, 5.0, "Forward 1.0 m/s 5s"),
        # (0.0,  0.0, 5.0, "Stop 5s"),

        (0.0,  -0.1, 5.0, "Turn left 0.1 rad/s 5s"),
        (0.0,  0.0, 5.0, "Stop 5s"),
        (0.0,  -0.2, 5.0, "Turn left 0.2 rad/s 5s"),
        (0.0,  0.0, 5.0, "Stop 5s"),
        (0.0,  -0.3, 5.0, "Turn left 0.3 rad/s 5s"),
        (0.0,  0.0, 5.0, "Stop 5s"),
        (0.0,  -0.4, 5.0, "Turn left 0.4 rad/s 5s"),
        (0.0,  0.0, 5.0, "Stop 5s"),
        (0.0,  -0.5, 5.0, "Turn left 0.5 rad/s 5s"),
        (0.0,  0.0, 5.0, "Stop 5s"),
        (0.0,  -0.6, 5.0, "Turn left 0.6 rad/s 5s"),
        (0.0,  0.0, 5.0, "Stop 5s"),
        (0.0,  -0.7, 5.0, "Turn left  rad/s 5s"),
        (0.0,  0.0, 5.0, "Stop 5s"),
        (0.0,  -0.8, 5.0, "Turn left 0.8 rad/s 5s"),
        (0.0,  0.0, 5.0, "Stop 5s"),
    ]
