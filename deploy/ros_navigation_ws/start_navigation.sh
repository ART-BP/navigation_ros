...
gnome-terminal --window -e 'bash -c "source ~/ros_navigation_ws/install/setup.bash;roslaunch omni_navigation real_navigation_ll_B4_kfq.launch local_planner:=teb dog_name:=small_dog rviz:=true; exec bash"' \
